    ...
    public function run() {
        ...
        DB::table('validations')->insert([
            array(
                ...
                "is_mandatory" => 1,
                'comments' => 'The field under validation must be entirely Unicode alphabetic characters contained ([a-zA-Z_]{2,})',
                "status" => 1,
                "created_at" => now(),
                "updated_at" => now(),
                "deleted_at" => NULL,
            ...
            array(
                "validation_name" => "alpha_num type validation",
                "validation_value" => 'alpha_num',
                "is_mandatory" => 1,
                'comments' => 'The field under validation must be entirely Unicode alpha-numeric characters contained ([a-zA-Z_]{2,})([0-9]{1,})',
                "status" => 1,
                "created_at" => now(),
                "updated_at" => now(),
                "deleted_at" => NULL,
            ...
            // ),
            array(
                "validation_name" => "email type validation",
                "validation_value" => 'email',
                "is_mandatory" => 2,
                'comments' => 'The field under validation must be formatted as an email address ex(email:rfc,dns) rfc: RFCValidation, dns: DNSCheckValidation ([a-zA-Z_]{2,})([0-9]{0,})([@]{1})([a-z]{3,})([.]{1})([a-z]{2,20})',
                "status" => 1,
                "created_at" => now(),
                "updated_at" => now(),
                "deleted_at" => NULL,
